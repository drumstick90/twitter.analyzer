...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Esempi:
  python scraper_lean.py md_pier
  python scraper_lean.py -u guruanaerobic
  python scraper_lean.py -u elonmusk --api-key YOUR_KEY
        """
    )
    ...
    if not username:
        ...
        print("Esempi:")
        print("  python scraper_lean.py md_pier")
        print("  python scraper_lean.py -u guruanaerobic")
        sys.exit(1)
